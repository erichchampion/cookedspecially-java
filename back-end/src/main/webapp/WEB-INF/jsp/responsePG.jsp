...
$(function() {
	var respMsz= "${STATUS}";
	var mobiKwik = "${MOBIKWIK}";
	if(respMsz=="CANCELED"){
		$( "#cancelpopup" ).popup("open" );
		var aDiv = document.getElementById("check-content");
        aDiv.style.display = "none";
	}
	else if (mobiKwik=="Active"){
...
<div data-role="header" data-id="globalHeader" data-theme="d" data-position="fixed">
			...
			<a id="done-button" href="${restaurant.websiteURL}" data-role="button" data-inline="true" data-icon="home">Done</a> 
...
<div data-role="popup" id="errorpopup" data-theme="d" data-dismissible="false" data-history="false">
			 <div  id="errorpopup-content" data-role="content"> 
				<p><B> Transaction Failed !</B></p>
				<p style="text-align:left" class="Charges_message">Error Message : ${RESPMSG}</p>
				<p style="text-align:left" id="message" class="Charges_message"><b>Note:</b> Payment Gateway was unable to process your payment request.In case the money has been debited at your end. Kindly call the resturant at : ${CONTACT}.
				</p>
				<div><button type="button"  id="outmail" onclick="autoEmail();"  class="ui-btn ui-corner-all ui-shadow ui-btn-d ui-btn-icon-left ui-icon-check">Close</button></div>
			</div> 
</div>

<div data-role="popup" id="cancelpopup" data-theme="d" data-dismissible="false" data-history="false">
			 <div  id="errorpopup-content" data-role="content"> 
				<p><B> Transaction Failed !</B></p>
				<p style="text-align:left" class="Charges_message">Error Message : ${RESPMSG}</p>
				<p style="text-align:left" class="Charges_message"><b>Note:</b> You choose to cancel the payment process and hence the order has not been placed.
				</p>
				<div><button type="button"  id="outmail" onclick="autoClose();"  class="ui-btn ui-corner-all ui-shadow ui-btn-d ui-btn-icon-left ui-icon-check">Close</button></div>
			</div> 
</div>
...
<!--<div data-role="popup" id="popupEmail" data-theme="d" class="ui-corner-all" data-dismissible="false" data-history="false">
			 <a href="#" onclick="$('#popupEmail').popup('close');" data-role="button" data-theme="d" data-icon="delete" data-iconpos="notext" class="ui-btn-left">Close</a> 
			<form onsubmit="return false;">
				<h3>Please let us email your receipt.</h3>
				<label for="customerEmail" class="ui-hidden-accessible">Email Address</label>
				<input type="email" maxlength="100" name="customerEmail" id="customerEmail" value="" placeholder="Email Address" data-theme="d"/>
				<button type="button" onclick="emailCheck();" class="ui-btn ui-corner-all ui-shadow ui-btn-d ui-btn-icon-left ui-icon-check">Continue</button>
</form>
</div>-->
...
<hr/>
<c:if test = "${restaurant.tinNo !=null}">
...
<!--  Note: PayTM was unable to process your payment request. However, the order was placed successfully. We shall see you shortly and collect cash instead.
 -->
<!-- </div> -->
