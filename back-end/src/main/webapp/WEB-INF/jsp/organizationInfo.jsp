...
<form:form method="post" action="organization/addRestaurant.html" commandName="restaurant">
	...
	<table>	
     <tr>
		<td><form:label path="restaurantName">Organization Name*</form:label></td>
	...
	<tr>
		...
		<%-- <form:input path="country" required="true" class="validate[maxSize[100]]"/> --%></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><form:input path="websiteURL" type="text" step="any"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td><form:label path="openFlag">Organization Open Flag : </form:label></td>
		<td>
	...
	<tr>
		<td><form:label path="closedText">Organization closed display text</form:label></td>
	...
	<tr>
		<td colspan="2">
			<input type="submit" value="Save" style="background-color:#8DC360"/>
