...
public class CacheConfig {
    ...
    @Value("${spring.cache.redis.time-to-live:600000}") // 10 minutes default
    ...
    /**
     * Redis cache manager with custom TTL for different caches
     */
    @Bean
