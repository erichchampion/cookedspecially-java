 ...
 * CONSTANTS
 */
var appVersion = '1.9.4';
var appLatestVersion = '1.9.4';
...
var comCookedSpeciallyRestaurantApi = comCookedSpeciallyApiPrefix + "/CookedSpecially/menu/getallmenusjson/" + restaurantId;
...
if ( serverName.indexOf("bakedspecially.com:8080") == -1 ){
    var comCookedSpeciallyRestaurantApi = "/api/getMenus.php?restaurantId=" + restaurantId;
}
        ...
        if (navigator.onLine) {
                ...
                .done (function (data) {
                        ...
                        globalDataRemote = JSON.parse(globalDataRemoteString);
								...
								console.error("Error parsing globalDataRemoteString: " + error);
						}
                })
                .fail(function() { 
...
//console.log("DEBUG > BEGIN updateAjaxDataLocal");     
        ...
        //console.log("Read data: " + globalDataLocalString);
				...
				console.error("Error parsing globalDataLocalString: " + error);
		}
