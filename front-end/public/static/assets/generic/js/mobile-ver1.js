...
function addMenuToHomePage(menuId, name, description, imageUrl) {
	var theMenu = '<a data-role="button" data-theme="c" class="topMenuBtn ui-btn ui-shadow ui-btn-corner-all ui-btn-up-c" id="' + menuId + '" href="#' + menuId + '" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">' + name + '<\/span><\/span><div class="buttonFooter"></div><\/a>';
