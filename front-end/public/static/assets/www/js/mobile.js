...
function addMenuPage(menuId, name, description) {
	...
	var thePage = '<div data-role="page" id="' + menuId + '" data-url="' + menuId + '">' +
                  ...
                  '    <div id="nav">' +
				  '      <a id="home-button" href="#home">Menus</a> <span id="separator-button">&gt;</span> ' +
				  '      <a id="menu-button" onclick="toggleMenuItems()" >' + name + '</a> <span id="separator-button">&gt;</span> ' +
