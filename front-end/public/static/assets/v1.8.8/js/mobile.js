...
var appVersion = '1.8.8';
var appLatestVersion = '1.8.8';
...
function showItemDetail(m,s,i) {
	...
	// Remember to use the cached copy of the image you're trying to display.
	ImgCache.useCachedBackground($('#' + p + ' .itemDetailImg'));
	// Then, show the item
    $('#' + p + ' .shade').show();
    $('#' + p + ' .itemDetail').show();
